...
func TestSimulateMsgCreateValidator(t *testing.T) {
	...
	require.Equal(t, "0.000000000000000000", msg.Commission.MaxChangeRate.String())
	require.Equal(t, "1.000000000000000000", msg.Commission.MaxRate.String())
	require.Equal(t, "1.000000000000000000", msg.Commission.Rate.String())
...
func TestSimulateMsgEditValidator(t *testing.T) {
	...
	require.True(t, operationMsg.OK)
	require.Equal(t, "UzXPFGkqEG", msg.Description.Moniker)
	require.Equal(t, "yNhYFmBZHe", msg.Description.Identity)
